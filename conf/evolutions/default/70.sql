...
update reports set tags = array_replace(tags, 'Ehpad','Ehpad');
...
update reports set tags = array_replace(tags, 'Bloctel','Bloctel');
update reports set tags = array_replace(tags, 'Influenceur','Influenceur');
update reports set tags = array_replace(tags, 'ReponseConso','ReponseConso');
update reports set tags = array_replace(tags, 'Internet','Internet');
