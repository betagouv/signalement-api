    ...
    for d in iter_csv(path):
        ...
        if count < 10000:
            if args.type == SIRET:
                ...
                d['denominationUsuelleEtablissement'] = d['denominationUniteLegale'] or d['denominationUsuelle1UniteLegale'] or d['denominationUsuelle2UniteLegale'] or d['denominationUsuelle3UniteLegale'] or s['prenomUsuelUniteLegale'] + ' ' + s['nomUsageUniteLegale']
