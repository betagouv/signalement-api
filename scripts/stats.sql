...
where u.role = 'DGCCRF'
and u.email = a.login
and a.timestamp >= '2021-04-01'::timestamp - '60 days'::interval;
...
and creation_date >= '2021-04-01'::timestamp - '60 days'::interval;
...
from reports
where creation_date >= '2021-04-01'::timestamp - '60 days'::interval;
...
((count(1) filter ( where  positive = false))::numeric / count(1) * 100)::numeric(5,2) "% avis négatif"
from ratings
where creation_date >= '2021-04-01'::timestamp - '200 days'::interval
group by category;
...
from reports
where creation_date >= '2021-04-01'::timestamp - '30 days'::interval;
