...
class TokenKindTest extends Specification {
  ...
  "TokenKind" should {
    ...
    "get string value correctly" in {
      ...
      TokenKind.DGALAccount.entryName mustEqual "DGAL_ACCOUNT"
    ...
    "find from value correctly" in {
      ...
      TokenKind.withName("DGAL_ACCOUNT") mustEqual DGALAccount
    ...
    "serialize Json correctly" in {
      ...
      Json.toJson(TokenKind.DGALAccount) mustEqual JsString("DGAL_ACCOUNT")
    ...
    "deserialize Json correctly" in {
      ...
      JsString("DGAL_ACCOUNT").as[TokenKind] mustEqual DGALAccount
