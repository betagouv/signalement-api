  ...
  "ReportFilter" should {
    ...
    "fromQueryString should parse successfully" in {
      ...
      val expectedReportFilter = ReportFilter(
        ...
        websiteExists = Some(true),
        phoneExists = Some(true),
      ...
      val input = Map[String, Seq[String]](
        ...
        "websiteExists" -> expectedReportFilter.websiteExists.toSeq.map(_.toString),
        "phoneExists" -> expectedReportFilter.phoneExists.toSeq.map(_.toString),
